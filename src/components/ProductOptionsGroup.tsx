    ...
    <tr className="*:border-b *:py-1 *:px-2" key={oIndex}>
      ...
      <td className="border-l border-r">
        <input
          ...
          {...register(`optionGroups.${ogIndex}.options.${oIndex}.option`)}
        />
      </td>
      <td>
        <input
          ...
          type="text"
          className="w-full capitalize outline-0 py-2 px-2 bg-slate-100 rounded-md border border-slate-300"
          {...register(`optionGroups.${ogIndex}.options.${oIndex}.desc`)}
        />
      </td>
      <td className="border-l border-r">
        <label className="flex w-full outline-0 *:py-2 *:px-2  overflow-hidden *:bg-slate-100 rounded-md border border-slate-300">
          ...
          <input
            ...
            {...register(`optionGroups.${ogIndex}.options.${oIndex}.price`)}
          />
        </label>
      </td>
        ...
        <div className="flex justify-center ">
          <label className="flex">
            <input
              ...
              {...register(`optionGroups.${ogIndex}.options.${oIndex}.default`)}
            ></input>
      ...
      <td>
        {oIndex ? (
          <button className="flex items-center mx-auto justify-center border-primaryColor rounded-md w-7 h-7 bg-primaryColor text-white">
                ...
                <table id="productOptionTable" className="w-full">
                  <thead>
                    <tr className="*:text-left *:font-poppins *:font-normal *:border-b *:border-t *:px-2 *:py-2 *:text-gray-500 *:text-xs">
                      <th onClick={() => addNewOptionGroup(ogIndex)}>
