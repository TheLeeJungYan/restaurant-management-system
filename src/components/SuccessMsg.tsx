...
const SuccessMsg:React.FC<{msg:string|null}> = ({msg}) =>{
    return (
        <div className={`flex rounded-xl mb-2 font-poppins  bg-green-200/50 items-center transition-all duration-1000 overflow-hidden ${msg?' border h-20 opacity-1':'h-0 opacity-0'}`}>
            ...
            <button type="button" className="ml-auto text-gray-400 hover:text-gray-600 mr-4">
