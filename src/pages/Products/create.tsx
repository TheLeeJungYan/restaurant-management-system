        ...
        <div className="flex justify-between mt-5">
          <div className="flex flex-col">
            ...
            <span className="font-poppins text-gray-500 mt-2 text-xs">
              ...
              required details such as the product name, description, price, and
              etc...
            </span>
          </div>
        ...
        <div className="flex flex-1 gap-5 mt-5">
          ...
          <div className="flex flex-col basis-1/3 gap-5 ">
            ...
            <InputContainer title={"Product Image"}>
              <div className="h-72 border border-gray-300 rounded-md border-dashed flex items-center justify-center flex-col font-poppins">
                <Image02Icon size={24} className="text-gray-400" />
